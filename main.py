...
# ✅ Correct imports for Solana - PROXY FIXED VERSION
...
from solana.rpc.providers.http import HTTPProvider  # NEW: Import directly
...
class VenomRugBot:
    def __init__(self):
        ...
        # FIXED: Create Solana client without proxy issues
        provider = HTTPProvider(SOLANA_RPC_URL)  # NEW: Use HTTPProvider directly
        self.solana_client = Client(provider=provider)  # NEW: Pass provider instead of URL
...
def main():
    ...
    print("🔧 FIXED: Proxy issues completely removed")
